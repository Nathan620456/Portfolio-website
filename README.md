This website contains some html files, css files only one javascript file because for some reason javascript wouldn't work as an external file on vs when trying to upload to google.
